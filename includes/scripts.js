					...
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
				  	...
				  	<div class="collapse navbar-collapse" id="myNavbar" aria-expanded="false" style="height: 0px;">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">					
								<a class = "dropdown-toggle" data-toggle="dropdown" href="pages/resources/index.html">
							...
							<li class="dropdown">
								<a class="dropdown-toggle" data-toggle="dropdown" href="pages/career/index.html">
					      			Careers
							...
							<li class="dropdown">
								<a class="dropdown-toggle" data-toggle="dropdown" href="pages/projects/index.html">
