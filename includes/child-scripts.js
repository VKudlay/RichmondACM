...
// Used by header function specifically
    //$("#header").load("../../includes/child-header.html");
				...
				<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
			  	...
			  	<div class="collapse navbar-collapse" id="myNavbar" aria-expanded="false" style="height: 0px;">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">					
							<a class = "dropdown-toggle" data-toggle="dropdown" href="../resources/index.html">
						...
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="../career/index.html">
				      			Careers
						...
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="../projects/index.html">
